package es.upm.etsisi.iot.api.http_errors;
...
import es.upm.etsisi.iot.domain.exceptions.ForbiddenException;
import es.upm.etsisi.iot.domain.exceptions.NotFoundException;
